...
const footerTextClass = `${fontSize.mobile} ${fontSize.sm} ${fontSize.md} ${fontSize.lg} ${fontSize.xl} ${fontSize.xl2}`;
  ...
  return (
    <footer className="mt-16 text-center">
      ...
      <nav className="hidden xl:block">
        <ul
          className={`${footerTextClass} flex justify-center xl:gap-5`}
        >
          <li>
      ...
      <p
        className={`${footerTextClass} pb-10`}
      >
